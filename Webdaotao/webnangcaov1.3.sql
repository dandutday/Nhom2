...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 09, 2019 lúc 07:32 PM
...
(6, 'Bảo trì máy tính', 'Phàn cứng, phần mềm và cách sửa lỗi', 80);
...
(6, 14, 'Xuan', 'Manh', '0000-00-00', '', ''),
(7, 15, 'Nghiêm Xuân', 'Hiếu', '0000-00-00', '', '');
...
(14, 5, 'Manh', '2810', 'naa.lntu@gmail.com', '+8437928623', 1, '0000-00-00'),
(15, 5, 'nghiemxuanhieu', '2305', 'nghiemxuanhieu97@gmail.com', '0367896040', 1, '0000-00-00');
...
--
ALTER TABLE `dangky`
  MODIFY `DK_ID` smallint(6) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `diem`
--
ALTER TABLE `diem`
  MODIFY `D_ID` smallint(6) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `hocphi`
--
ALTER TABLE `hocphi`
  MODIFY `KH_ID` smallint(6) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `khoahoc`
--
ALTER TABLE `khoahoc`
  MODIFY `KH_ID` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `lop`
  MODIFY `LP_ID` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT cho bảng `monhoc`
--
ALTER TABLE `monhoc`
  MODIFY `MH_ID` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT cho bảng `nguoidung`
--
ALTER TABLE `nguoidung`
  MODIFY `ND_ID` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `taikhoan`
  MODIFY `TK_ID` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT cho bảng `thoikhoabieu`
--
ALTER TABLE `thoikhoabieu`
  MODIFY `TKB_ID` smallint(6) NOT NULL AUTO_INCREMENT;
