...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 09, 2019 lúc 02:56 PM
...
--
ALTER TABLE `nguoidung`
  MODIFY `ND_ID` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `taikhoan`
  MODIFY `TK_ID` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
